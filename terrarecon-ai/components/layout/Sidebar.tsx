...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-sidebar-width bg-surface-container-low border-r border-outline-variant flex flex-col py-xl transition-all duration-200 ease-in-out z-50">
